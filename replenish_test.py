...
time.sleep(1)
element = driver.find_element_by_id("add")
...
button.click()
time.sleep(1)
#if add success, it will return to success message page
...
#if credit card check correct, it will redirect to success page. 
#if not, it will redirect to fail page
